        ...
        <div className="grid md:grid-cols-[3fr,2fr] gap-10">
          <div>
            ...
            <div className="space-y-3 text-sm text-slate-700 mb-8">
              <p>
                ...
                <a
                  href="mailto:info@cypressfreight.ca"
                  className="text-emerald-700 hover:underline"
                >
                  info@cypressfreight.ca
                </a>
              </p>
              <p>
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-5 text-sm">
            ...
            <p className="text-slate-600">
              If you&apos;re looking for a consistent carrier or dedicated
              lanes, mention this in your message and we&apos;ll schedule a
              call to review your requirements.
            </p>
          </div>
        </div>
      </section>
